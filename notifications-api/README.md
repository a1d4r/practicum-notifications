...
```bash
git clone https://github.com/a1d4r/practicum-notifications.git
...
More information [about docker](https://github.com/a1d4r/practicum-notifications/tree/master/docker).
